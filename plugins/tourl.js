  ...
  try {
    ...
    if (!m.quoted || !["imageMessage", "videoMessage", "audioMessage"].includes(m.quoted.mtype)) {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ Yo, *SNOWBIRD-XD* needs a quoted image, video, or audio, fam! 📸🎥🎵
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    const { key } = await Matrix.sendMessage(
      m.from,
      { text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* uploadin’ your media... ${loadingMessages[currentMessageIndex]} 🚀
◈━━━━━━━━━━━━━━━━◈` },
      { quoted: m }
    );
...
◈━━━━━━━━━━━━━━━━◈`,
    ...
    if (mediaType === "audio") {
      await Matrix.sendMessage(
        ...
        {
          text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* got your audio URL, fam! 🎵
│❒ 🔗 *URL*: ${mediaUrl}
◈━━━━━━━━━━━━━━━━◈`,
        },
        { quoted: m }
      ...
      await Matrix.sendMessage(
        m.from,
        {
          ...
          caption: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* got your ${mediaType} URL, fam! 📸🎥
│❒ 🔗 *URL*: ${mediaUrl}
◈━━━━━━━━━━━━━━━━◈`,
        },
        { quoted: m }
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* hit a snag uploadin’, fam! Try again! 😈
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  }
};

  ...
  try {
    ...
    if (!m.isGroup) {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ Yo, *SNOWBIRD-XD* only kicks in groups! 🏠
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    if (!botAdmin) {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* needs admin powers to kick, fam! 😡
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
...
◈━━━━━━━━━━━━━━━━◈`,
    ...
    if (users.length === 0) {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ Tag or quote someone to kick, fam! Don’t ghost *SNOWBIRD-XD*! 😤
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    if (validUsers.length === 0) {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ Can’t kick nobody, fam! Check the tags or don’t try kickin’ yourself or *SNOWBIRD-XD*! 😜
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ ${kickedNames} got yeeted from *${groupMetadata.subject}* by *SNOWBIRD-XD*! 👊💥
◈━━━━━━━━━━━━━━━━◈`,
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* hit a snag kickin’, fam! Try again! 😈
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  }
};

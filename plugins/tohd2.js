  ...
  try {
    ...
    if (!m.quoted || m.quoted.mtype !== "imageMessage") {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ Yo, *SNOWBIRD-XD* needs a quoted image to enhance, fam! 📸
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* crankin’ up that image quality... 🔍✨
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
    ...
    await Matrix.sendMessage(
      m.from,
      {
        ...
        caption: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* made your image HD AF, fam! 🖼️🔥
◈━━━━━━━━━━━━━━━━◈`,
      },
      { quoted: m }
    );
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* hit a snag enhancin’ that pic, fam! Try again! 😈
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  }
};

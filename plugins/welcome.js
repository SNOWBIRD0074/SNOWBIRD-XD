...
◈━━━━━━━━━━━━━━━━◈`,
      ...
      if (!botAdmin) {
        return Matrix.sendMessage(m.from, {
          text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* needs admin powers to run this, fam! 😡
◈━━━━━━━━━━━━━━━━◈`,
        }, { quoted: m });
      }
...
◈━━━━━━━━━━━━━━━━◈`,
      ...
      if (text === "on") {
        config.WELCOME = true;
        responseMessage = `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* welcome & left messages ON! Newbies beware! 😈
◈━━━━━━━━━━━━━━━━◈`;
      } else if (text === "off") {
        config.WELCOME = false;
        responseMessage = `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* welcome & left messages OFF! Silent mode, fam! 💀
◈━━━━━━━━━━━━━━━━◈`;
      } else {
        responseMessage = `◈━━━━━━━━━━━━━━━━◈
│❒ Yo, use it right, fam!
...
◈━━━━━━━━━━━━━━━━◈`;
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* hit a snag, fam! Try again, we still savage! 😈
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  }
};

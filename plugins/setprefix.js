  ...
  try {
    ...
    if (!isCreator) {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ Yo, only *SNOWBIRD-XD*’s boss can touch this, fam! 🔐
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    if (!text) {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ Gimme a new prefix, fam! Don’t leave *SNOWBIRD-XD* hangin’! 😎
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
...
◈━━━━━━━━━━━━━━━━◈`,
    ...
    try {
      ...
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* couldn’t save the prefix, fam! Check the server! 😣
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* prefix switched to *${text}*! You’re runnin’ the show, fam! 🔧🔥
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  } catch (error) {
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* hit a snag, fam! Try again! 😈
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  }
};

  ...
  try {
    ...
    if (!isBot) {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ Get lost, poser! Only *SNOWBIRD-XD* itself can flex this command! 😤🔒
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    if (!m.quoted?.message?.imageMessage) {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ Yo, dumbass, reply to a damn *image* for *SNOWBIRD-XD*’s glow-up! 🖼️😆
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    for (let i = 0; i < 3; i++) {
      try {
        ...
        if (i === 2) {
          ...
          return Matrix.sendMessage(m.from, {
            text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* can’t grab that image, fam! Shit’s broken, try again! 😣
◈━━━━━━━━━━━━━━━━◈`,
          }, { quoted: m });
        }
      }
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD*’s new drip is fuckin’ 🔥! Profile pic set, boss! 😎💪
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  } catch (error) {
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* fucked up settin’ that pic, fam! Try again, you got this! 😈
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  }
};

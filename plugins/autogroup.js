  ...
  try {
    ...
    if (!m.isGroup) {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ Yo, dumbass, *SNOWBIRD-XD* only runs this in groups! Get with it! 😤🏠
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    if (!botAdmin) {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* ain’t got admin juice to run this! Promote me, scrub! 😡🔧
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
...
◈━━━━━━━━━━━━━━━━◈`,
    ...
    if (args.length < 1) {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ Yo, braindead, tell *SNOWBIRD-XD* what to do! Use *open*/*unmute* or *close*/*mute* [time]! 😆
...
◈━━━━━━━━━━━━━━━━◈`,
    ...
    if (!time) {
      if (groupSetting === "close") {
        ...
        return Matrix.sendMessage(m.from, {
          text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* locked this group down tight! No chatter, fam! 🔒💥
◈━━━━━━━━━━━━━━━━◈`,
        }, { quoted: m });
        ...
        return Matrix.sendMessage(m.from, {
          text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* flung the gates open! Talk your shit, fam! 🗣️🔥
◈━━━━━━━━━━━━━━━━◈`,
        }, { quoted: m });
      } else {
        return Matrix.sendMessage(m.from, {
          text: `◈━━━━━━━━━━━━━━━━◈
│❒ What’s this trash? *SNOWBIRD-XD* only takes *open*/*unmute* or *close*/*mute*, clown! 🤡
│❒ Ex: *${prefix}group open* or *${prefix}group close 16:00*
◈━━━━━━━━━━━━━━━━◈`,
        }, { quoted: m });
      }
        ...
        try {
          ...
          if (groupSetting === "close") {
            ...
            await Matrix.sendMessage(m.from, {
              text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* shut this group down! Quiet time, fam! 🔒💥
◈━━━━━━━━━━━━━━━━◈`,
            });
          } else if (groupSetting === "open") {
            await Matrix.groupSettingUpdate(m.from, "not_announcement");
            await Matrix.sendMessage(m.from, {
              text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* opened the floodgates! Let’s get loud, fam! 🗣️🔥
◈━━━━━━━━━━━━━━━━◈`,
            });
          }
        } catch (err) {
          ...
          await Matrix.sendMessage(m.from, {
            text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* fucked up the schedule, fam! Somethin’s busted! 😈
◈━━━━━━━━━━━━━━━━◈`,
          });
        }
      },
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* set to ${groupSetting === "close" ? "lock" : "open"} *${groupMetadata.subject}* at *${time}* EAT! You’re runnin’ this, boss! 💪🔥
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  } catch (error) {
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* screwed up somewhere, fam! Try that again! 😈
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  }
};

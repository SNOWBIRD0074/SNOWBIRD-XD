  ...
  try {
    ...
    if (!quoted || (quoted.mtype !== "audioMessage" && quoted.mtype !== "videoMessage")) {
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ Yo, *SNOWBIRD-XD* needs a quoted audio or video to ID, fam! 🎵
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    try {
      ...
      await Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* sniffin’ out that track, hold up... 🔍
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
...
◈━━━━━━━━━━━━━━━━◈`;
      ...
      await Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* couldn’t ID that track, fam! Try another! 😣
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
  } catch (error) {
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* hit a glitch, fam! Retry that jam! 😈
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  }
};

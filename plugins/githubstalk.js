  ...
  try {
    ...
    if (!args[0]) {
      return Matrix.sendMessage(m.from, {
        text: `◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ Yo, dumbass, gimme a *GitHub username* to stalk! Don’t waste *SNOWBIRD-XD*’s time! 😤💾
...
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`,
    ...
    if (githubResponse.status !== 200 || !userData.login) {
      ...
      return Matrix.sendMessage(m.from, {
        text: `◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ *SNOWBIRD-XD* can’t find that GitHub user, fam! Check the username, clown! 🤡
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`,
      }, { quoted: m });
    }
...
│❒   🍴 *Forks*: ${repo.forks_count || 0}`;
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈
│❒ *SNOWBIRD-XD* fucked up stalkin’ that user, fam! Try again or check the name! 😈
◈┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅◈`,
    }, { quoted: m });
  }
};

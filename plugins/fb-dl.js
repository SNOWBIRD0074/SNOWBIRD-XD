...
◈━━━━━━━━━━━━━━━━◈`,
    ...
    if (!data.success || !data.result) {
      ...
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* couldn’t grab that video, fam! URL’s trash or somethin’s busted! 😣
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    if (!videoUrl) {
      ...
      return Matrix.sendMessage(m.from, {
        text: `◈━━━━━━━━━━━━━━━━◈
│❒ No video worth downloadin’ here, fam! *SNOWBIRD-XD* ain’t got time for this shit! 😆
◈━━━━━━━━━━━━━━━━◈`,
      }, { quoted: m });
    }
    ...
    const caption = `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* Facebook Video 📹
│❒ 🎬 *Title*: ${title || "No title"}
│❒ 📥 *Quality*: ${quality}
│❒ 💥 Powered By *SNOWBIRD-XD* 🖤
◈━━━━━━━━━━━━━━━━◈`;
    ...
    await Matrix.sendMessage(m.from, {
      text: `◈━━━━━━━━━━━━━━━━◈
│❒ *SNOWBIRD-XD* fucked up grabbin’ that video, fam! Try again, you got this! 😈
◈━━━━━━━━━━━━━━━━◈`,
    }, { quoted: m });
  }
};
